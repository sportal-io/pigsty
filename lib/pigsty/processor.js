...
function makeJson(object) {
  ...
  //console.log("object type:", object, typeof object);
 ...
 //     console.log("XXX", k, typeof(object[k]))
      var item = object[k];
...
EventProcessor.prototype.start = function() {
  ...
  self.watch = setInterval(function() {
    ...
    if (self.current_event) {
      ...
      var thirtysecondsago = new Date((new Date()).getTime() - 10 * 1000);
...
EventProcessor.prototype._flush_current_event = function() {
  ...
  if (self.current_event) {
  //  console.log(JSON.stringify(self.current_event.json()))
